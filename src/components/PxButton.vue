...
export default {
  ...
  methods: {
    buttonClick() {
      // Emitiremos un evento al hacer click para que el padre manipule el evento interno
...
<!-- Importamos este boton en el componente donde lo vamos a usar, en este caso PxAssetsTable -->
